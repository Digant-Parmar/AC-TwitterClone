...
public class SendTweet extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSeeTweets = findViewById(R.id.btnSeeTweets);
        listTweets = findViewById(R.id.listViewTweets);
        btnSeeTweets.setOnClickListener(this);
    ...
    public void sendTweet(View view){
        ...
        parseObject.put("tweet",edtSend.getText().toString());
        ...
        parseObject.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e==null){
                    FancyToast.makeText(SendTweet.this,"Sent",FancyToast.LENGTH_SHORT,FancyToast.SUCCESS,true).show();
